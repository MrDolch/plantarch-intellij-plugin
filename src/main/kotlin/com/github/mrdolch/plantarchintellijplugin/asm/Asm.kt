...
data class Parameters(
  val title: String?,
  val caption: String?,
    var classesToAnalyze: Set<String> = emptySet(),
    var classesToHide: Set<String> = emptySet(),
    var markerClasses: MarkerClasses = MarkerClasses(emptySet()),
    var librariesToHide: Set<String> = emptySet(),
